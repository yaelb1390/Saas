 ...
 *
 * Vivían dentro del layout como una variable local, así que solo los veía la barra lateral. En
 * cuanto otra pantalla necesitó uno —las tarjetas de cifras de Reportes y Monitoreo— la alternativa
 * era copiar la ruta SVG, y dos copias de un dibujo divergen igual que dos copias de una regla: se
 * ajusta el grosor en una y la otra se queda distinta sin que nadie lo note.
 *
 * Son trazos de 24x24 pensados para dibujarse con `stroke`, no rellenos: el color lo pone quien los
 * usa con `currentColor`. Por eso se guarda solo el interior del `<svg>` y no el elemento entero.
 */
final class Icons
{
    ...
    private const PATHS = [
        ...
        'pulse' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h3l2.25-6 4.5 12 2.25-6h4.5"/>',
        'target' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a12.02 12.02 0 0 0 .616-6.58A11.955 11.955 0 0 1 12 2.944a11.955 11.955 0 0 1-4.166 4.848 12.02 12.02 0 0 0 .617 6.58m5.84-2.58a14.98 14.98 0 0 1-5.84 2.58m0 0a6 6 0 0 1-7.38-5.84h4.8m2.58 5.84a14.98 14.98 0 0 1-2.58-5.84"/>',
        // Las del compositor de redes: megáfono para el rótulo, foto para la zona de subir,
        // reloj para la hora, avión para el botón que publica, y la marca y la cruz de las fichas.
        'megafono' => '<path stroke-linecap="round" stroke-linejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 1 1 0-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 0 1-1.44-4.282m3.102.069a18.03 18.03 0 0 1-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 0 1 8.835 2.535M10.34 6.66a23.847 23.847 0 0 0 8.835-2.535m0 0A23.74 23.74 0 0 0 18.795 3m.38 1.125a23.91 23.91 0 0 1 1.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 0 0 1.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 0 1 0 3.46"/>',
        'foto' => '<path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"/>',
        'subir' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 7.5 7.5 12M12 7.5v11.25"/>',
         ...
         * dependencia más es más peso, otra cosa que actualizar y un segundo estilo de trazo conviviendo
         * con el que ya tiene todo el panel.
         */
        'telefono' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z"/>',
        'mapa' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z"/>',
        'navegar' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5"/>',
        // La mira de «estoy aquí»: se distingue del pin del destino, que es otra cosa.
        'ubicacion' => '<path stroke-linecap="round" stroke-linejoin="round" d="M7.5 3.75H6A2.25 2.25 0 0 0 3.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0 1 20.25 6v1.5m0 9V18A2.25 2.25 0 0 1 18 20.25h-1.5m-9 0H6A2.25 2.25 0 0 1 3.75 18v-1.5M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>',

        // Las dos de la tendencia. Van con la punta gruesa y el trazo corto: a 0.75rem, que es como
        // se pintan, una flecha larga y fina se convierte en una mancha.
        'subida' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" d="M12 19V5m0 0-6 6m6-6 6 6"/>',
        'bajada' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4" d="M12 5v14m0 0 6-6m-6 6-6-6"/>',

        // Los cuatro del Centro de Impresión: la impresora y sus tres caminos de conexión.
        ...
        // No es un icono de Heroicons —no hay uno de Bluetooth en el set—: dibuja el rombo clásico
    ...
    /**
     * El trazo de un icono, o cadena vacía si no existe.
     *
     * Vacío y no una excepción: un icono que falta deja un hueco, y eso no justifica tumbar la
     * pantalla que lo pedía. Lo que sí lo caza es el test que recorre los nombres usados.
     */
    ...
    /** ¿Existe? Lo usa el test que comprueba que nadie pide uno que no está. */
