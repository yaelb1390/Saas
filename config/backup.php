...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Solo el contenido subido por los usuarios (logos, imágenes). El código vive en
                    // git y las dependencias en composer: no hace falta respaldarlos.
        ...
        'destination' => [
            ...
            /*
             * Discos donde se guardan los respaldos. Por defecto solo 'local'; para activar el
             * destino externo, pon en el .env: BACKUP_DISKS=local,r2 (tras configurar R2_*).
             */
            ...
            /*
             * Si un destino falla (p. ej. R2 mal configurado), continúa con los demás en vez de
             * abortar: así un problema con R2 no impide guardar el respaldo local.
             */
    ...
    'notifications' => [
        ...
        'mail' => [
            // Con MAIL_MAILER=log, los avisos se escriben en storage/logs. Al configurar SMTP,
