                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <x-panel.confirm-action
                                :action="route('panel.ai.documents.destroy', $doc)"
                                title="¿Eliminar «{{ $doc->title }}»?"
                                message="Sale de la base de conocimiento y la IA dejará de responder con lo que dice este documento."
                                note="Esto no se puede deshacer: se borran también sus {{ $doc->chunks_count }} fragmentos, y volver a tenerlo obliga a subirlo y reindexarlo."
                                irreversible
                                tooltip="Eliminar"
