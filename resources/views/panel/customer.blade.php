                                        ...
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            @can('customers.manage')
                                                <x-panel.confirm-action
                                                    :action="route('panel.customers.documents.destroy', [$customer, $doc])"
                                                    title="¿Eliminar «{{ $doc->name }}»?"
                                                    message="Se borra el archivo del cliente."
                                                    note="Esto no se puede deshacer: si lo necesitas otra vez, habrá que volver a subirlo."
                                                    irreversible
                                                    tooltip="Eliminar"
