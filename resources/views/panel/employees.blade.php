                            ...
                            <td>
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <x-panel.confirm-action
                                        :action="route('panel.employees.destroy', $employee)"
                                        title="¿Eliminar a «{{ $employee->name }}»?"
                                        message="Se archiva y deja de aparecer en la lista de empleados."
                                        note="Su historial de nómina y sus registros anteriores se conservan."
                                        tooltip="Eliminar"
