                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="bmos-card bmos-card-pad">
                        ...
                        {{--
                            ...
                            Y NINGUNA EMPUJA EL TOTAL FUERA DE LA VISTA. Con quince artículos el
                            ticket crecía hacia abajo y se llevaba por delante el total y el botón de
                            cobrar. La rejilla crece igual —usa `autoHeight`—, así que quien acota es
                            su marco, con la misma clase `.pos-ticket-scroll` que acotaba la tabla:
                            mismo objetivo, aplicado al widget que ahora manda en escritorio.
                        --}}
                        <div class="bmos-rejilla-marco pos-ticket-scroll hidden md:block">
